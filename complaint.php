...
if(isset($_POST['submit']))
{
	...
	if(isset($_GET['editid']))
	{
		...
		if(mysqli_affected_rows($con) == 1)
		{
			...
			echo "<script>window.location='dashboard.php?insid=$_GET[editid]';</script>";
		}
	}
	else
	{
...
<div class="row">
	...
	<div class="col-md-10">
		<input type="text" name="accusedby" id="accusedby" class="form-control" value="<?php echo $rsedit['accusedby']; ?>">
	</div>
</div><br>
...
<hr><br>						
<center><input type="submit" name="submit" class="form-control btn btn-primary" value="Update Complaint File" style='height: 60px;width: 250px;margin-top:3rem'></center>
					</div>
				</div>
			</div>
		</div>
