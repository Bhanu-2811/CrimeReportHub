					...
					<div class="panel-body">
						<div class="tab-content" style="height: 350px;">
							<div class="tab-pane active">
								...
								<div class="row">
									<div class="col-md-2">Accused</div>
									<div class="col-md-10">
										<input type="text" name="accusedby" id="accusedby" class="form-control" >
									</div>
								</div><br>
								<div class="row">
						...
						<br><br>					
						<center><input type="submit" name="submit" class="form-control btn btn-primary" value="Register Complaint" style='height: 60px;width: 250px; margin-top:3rem;'></center>
					</div>
				</div>
			</div>
		</div>
